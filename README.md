...
| [`examples/satellite-ocr-example`](examples/satellite-ocr-example/) | `mcp` | Tool `extract_text` | Tesseract dentro del contenedor, publicado como capability FHS P2P |
...
- Dependencias específicas por provider (ver cada README): `llama-server` para `star-example`; Tesseract se instala dentro del contenedor de `satellite-ocr`.
