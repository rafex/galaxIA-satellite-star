 ...
 * DEC-0050 en galaxIA). El protocolo FHS solo transporta una referencia
 * declarativa (`ModelInfo.toolCalling.parserProfile`) — el motor de
 * parseo en sí vive fuera del protocolo, aquí como copia local de este
 * Star hasta que se decida un mecanismo de distribución/actualización
 * automática del catálogo (pendiente, ver DEC-0050).
 */
 ...
 * DEC-0016/DEC-0017/DEC-0050) — generaliza lo que antes era una función
 * hardcodeada sin nombre (`tryParseFallbackToolCall`).
 */
